const data = {
    ...
    jumbo: {
        text: `Hi, I'm Andi Aldin. I design & build websites.`,
        buttonText: `Yes, I'm available for hire.`,
        buttonLink: `#contact`,
        scrollDownLink: '#about',
        img: `https://storage.googleapis.com/portofolio_img/img/desk4.jpg`
    },
    about: {
        img: `https://storage.googleapis.com/portofolio_img/img/me.jpg`,
        aboutText: `Passionate programmer pursuing a career path in web/app development and mixed reality technologies. I bring a strong background in Programmer and attention to detail that will increase engagement between your company and its target audience.`
    },
    portfolio: {
        backgroundImg: `https://storage.googleapis.com/portofolio_img/img/zipper.png`,
        projects: [{
                title: `Breakout`,
